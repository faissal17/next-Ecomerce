...
export default function PayPalButton({orderId, onPayPalLoading, ShowErrorToast}) {
    
    const handleButtonClick = async () => {
        try {
            onPayPalLoading(true);
            api("POST", "api/payment/create-paypal-payment", {orderId : orderId})
            .then((data) => {
    ...
    return (
        <button onClick={handleButtonClick} 
            className="bg-yellow-500 text-white rounded-md mx-auto p-2 w-full flex justify-center"
        >
